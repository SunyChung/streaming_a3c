...
from streaming_meta_a3c_single_worker import Worker

from_model_path = './streaming_a3c/streaming_meta_a3c_training/meta_a3c_train_1001/model_meta_a3c_1001'
to_model_path = './model_meta_a3c'
...
single_worker = Worker(Streaming_env(minute, repeat, generation_seed, wifi_cost, lte_cost), 0, a_size, repeat, trainer, to_model_path, global_episodes)
...
with tf.Session() as sess:
	...
	single_worker.work(gamma, sess, saver, train)
